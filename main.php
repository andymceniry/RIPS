...
**/
	...
	################################  RESULT  #################################	
?>	
<div id="window1" name="window" style="width:1080px; height: 80%; top: 68px !important; right: 410px; ">
	<div class="windowtitlebar">
		<div id="windowtitle1" onClick="toTop(1)" onmousedown="dragstart(1)" class="windowtitle"></div>
		<input id="maxbutton1" type="button" class="maxbutton hide" value="&nabla;" onClick="maxWindow(1, 800)" title="maximize" />
	...
	<div id="scrolldiv">
		...
		<div id="scrollcode" class="hide"></div>
	</div>
	<div id="windowcontent1" class="windowcontent" onscroll="scroller()" style="margin-left:0px !important;"></div>
...
<div id="window2" name="window" style="width: 750px; height: 80%; top: 68px !important; right: 410px;">
	<div class="windowtitlebar">
